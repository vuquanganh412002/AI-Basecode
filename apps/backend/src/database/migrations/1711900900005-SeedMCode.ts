...
export class SeedMCode1711900900005 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      ('PUBLISH_LOCATION', '3', 'メニュー画面（締め切り時間）', '締切時間', 3, 'お知らせ種別=4 (締め切り時間) 専用枠。1件のみ運用される。', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ...
      ('DOKUSYASO_BUNRUI', '0', '農業者', '農業者', 1, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('DOKUSYASO_BUNRUI', '1', 'JAグループ役職員', 'JA役職員', 2, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('DOKUSYASO_BUNRUI', '2', '企業・団体', '企業・団体', 3, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('DOKUSYASO_BUNRUI', '3', '学生', '学生', 4, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('DOKUSYASO_BUNRUI', '999', 'その他', 'その他', 5, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '0', '米', '米', 1, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '1', '野菜', '野菜', 2, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '2', '果実', '果実', 3, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '3', '花', '花', 4, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '4', '畜産', '畜産', 5, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '5', '酪農', '酪農', 6, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM'),
      ('NOGYOSYA_BUNRUI', '999', 'その他', 'その他', 7, '', '2026-01-01', 'SYSTEM', '2026-01-01', 'SYSTEM')
    `);
  }
