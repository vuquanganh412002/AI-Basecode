  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE t_file_upload (
        ...
        scheduled_delete_date TIMESTAMPTZ DEFAULT NULL,                     -- 削除予定日（NULL=未設定/期限なし）
    ...
    await queryRunner.query(`COMMENT ON COLUMN t_file_upload.scheduled_delete_date IS '削除予定日（NULL=未設定/期限なし）'`);
