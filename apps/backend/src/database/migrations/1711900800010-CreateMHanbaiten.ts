  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE m_hanbaiten (
        ...
        furikomi_tesuryo_futan_kubun INTEGER,                               -- 振込手数料負担区分（1:JA, 2:販売店）
        furikomi_tesuryo NUMERIC(10, 0),                                    -- 振込手数料
    ...
    await queryRunner.query(`COMMENT ON COLUMN m_hanbaiten.furikomi_tesuryo_futan_kubun IS '振込手数料負担区分（1:JA, 2:販売店）'`);
    await queryRunner.query(`COMMENT ON COLUMN m_hanbaiten.furikomi_tesuryo IS '振込手数料'`);
