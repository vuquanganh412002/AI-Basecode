...
// haitatsuryo_shiharai_cycle / furikomi_tesuryo_futan_kubun labels updated).
//
...
export function buildHanbaitenListResponse(
  ...
  return {
    data: rows.map((r) => ({
      ...
      furikomi_tesuryo_futan_kubun: r.furikomiTesuryoFutanKubun,
      furikomi_tesuryo: r.furikomiTesuryo,
