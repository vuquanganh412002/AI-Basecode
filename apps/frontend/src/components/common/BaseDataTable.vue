  ...
  <BaseCard no-padding>
    ...
    <a-table
      ...
      :pagination="{
        ...
        position: ['bottomLeft'],
        // The jaJP locale renders the page-size dropdown as
        // '20 件 / ページ' but the design specifies '20 / 頁'.
        // Overriding only `items_per_page` here keeps every other
        // pagination locale string (jump-to / total) on the global
        // jaJP defaults.
