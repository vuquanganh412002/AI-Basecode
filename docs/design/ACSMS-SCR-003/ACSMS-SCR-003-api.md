...
| 6   | →tanka_code        | String | -        |              | -        | 単価コード               |
| 7   | →tanka_name        | String | -        |              | -        | 単価名                   |
| 8   | →kingaku_zeikomi   | Number | -        |              | 〇       | 税込金額（円）           |
| 9   | →kingaku_zeinuki   | Number | -        |              | 〇       | 税抜金額（円）           |
| 10  | →tax_rate          | Number | -        | ##.##        | 〇       | 税率（%）                |
| 11  | →tekiyo_start_date | String | -        | YYYY-MM-DD   | 〇       | 適用開始日               |
| 12  | →tekiyo_end_date   | String | -        | YYYY-MM-DD   | 〇       | 適用終了日               |
| 13  | →created_at        | String | -        | ISO8601      | -        | 作成日時                 |
| 14  | →updated_at        | String | -        | ISO8601      | 〇       | 更新日時                 |
...
| 7   | tekiyo_start_date | String | -        | -    |        |        | 適用開始日（YYYY-MM-DD）。空欄の場合は現在日付 |
| 8   | tekiyo_end_date   | String | -        | -    |        |        | 適用終了日（YYYY-MM-DD）。空欄の場合は無期限   |
...
| 7   | tekiyo_start_date | String | -        | -    |        |        | 適用開始日（YYYY-MM-DD）              |
| 8   | tekiyo_end_date   | String | -        | -    |        |        | 適用終了日（YYYY-MM-DD）              |
...
| 4   | →tanka_type        | Number | -        |              | -        | 1: 購読料, 2: 配達手数料            |
| 5   | →tanka_type_label  | String | -        |              | -        | tanka_typeのラベル                  |
| 6   | →tanka_code        | String | -        |              | -        | 単価コード , 編集しないでください。 |
| 7   | →tanka_name        | String | -        |              | -        | 単価名                              |
| 8   | →kingaku_zeikomi   | Number | -        |              | 〇       | 税込金額（円）                      |
| 9   | →kingaku_zeinuki   | Number | -        |              | 〇       | 税抜金額（円）                      |
| 10  | →tax_rate          | Number | -        | ##.##        | 〇       | 税率（%）                           |
