...
| 56  | →bank_code                   | String  | -        |              |          | 金融機関コード（空文字許容）                                                                                  |
| 57  | →bank_name                   | String  | -        |              |          | 金融機関名（空文字許容）                                                                                      |
| 58  | →bank_branch_code            | String  | -        |              |          | 口座支店コード                                                                                                |
| 59  | →bank_branch_name            | String  | -        |              |          | 口座支店名                                                                                                    |
| 60  | →hikiotoshi_koza_no          | String  | -        |              |          | 引落口座番号（空文字許容）                                                                                    |
| 61  | →hikiotoshi_koza_meigi       | String  | -        |              |          | 引落口座名義（空文字許容）                                                                                    |
| 62  | →created_at                  | String  | -        | ISO8601      |          | 履歴作成日時                                                                                                  |
| 63  | →created_by                  | String  | -        |              |          | 履歴作成者                                                                                                    |
| 64  | meta                         | Object  | -        |              | -        | ページネーション情報                                                                                          |
| 65  | →total                       | Number  | -        |              | -        | 該当件数（履歴データ全体）                                                                                    |
| 66  | →page                        | Number  | -        |              | -        | 現在のページ                                                                                                  |
| 67  | →per_page                    | Number  | -        |              | -        | 1ページあたりの件数                                                                                           |
| 68  | →total_pages                 | Number  | -        |              | -        | 総ページ数                                                                                                    |
...
SELECT
  ...
  r.hikiotoshi_yokin_shubetsu, r.bank_code, r.bank_name,
