...
| 25.0 | 振込手数料負担区分 | col_20 | Checkbox | 入 |  | Boolean | 1 | 1 | INTEGER | 販売店マスタ | m_hanbaiten | 振込手数料負担区分 | furikomi_tesuryo_futan_kubun | 列パネル表示中 |
| 26.0 | 振込手数料 | col_21 | Checkbox | 入 |  | Boolean |  | 10 | NUMERIC(10,0) | 販売店マスタ | m_hanbaiten | 振込手数料 | furikomi_tesuryo | 列パネル表示中 |
