...
| 17  | →furikomi_tesuryo_futan_kubun             | Number | -        |              | 〇       | 振込手数料負担区分（※m_code.code_category='TESURYO_KUBUN'を参照、1:JA, 2:販売店） |
| 18  | →furikomi_tesuryo            | Number | -        | 0.00         | 〇       | 振込手数料                 |
...
SELECT hanbaiten_id, ja_id, hanbaiten_code, hanbaiten_name,
       ...
       haitatsuryo_shiharai_cycle, furikomi_tesuryo_futan_kubun, furikomi_tesuryo,
