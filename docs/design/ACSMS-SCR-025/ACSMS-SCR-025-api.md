...
SELECT a.account_id, a.login_id, a.account_name,
       ...
       a.email, a.paper_flg, a.denshi_flg, a.biko,
...
| リクエストパラメーター |                                                                                                                                                                                                                                                                     |
| ヘッダ                 | Content-Type: application/json※ 認証情報はHTTP-only Cookieにより自動的に送信される                                                                                                                                                                              |
| HTTPレスポンスコード   | 201:正常にアカウントを登録しました, 400:入力内容にエラーがあります, 401:セッションが切れました。再度ログインしてください, 403:この画面へのアクセス権限がありません, 500:システムエラーが発生しました |

## リクエストパラメータ

| #   | パラメーターID   | タイプ  | 繰り返し | 必須 | 最小長 | 最大長 | 説明                                                                                          |
| --- | ---------------- | ------- | -------- | ---- | ------ | ------ | --------------------------------------------------------------------------------------------- |
| 1   | login_id         | String  | -        | 〇   | 1      | 20     | ログインID（半角英数字のみ）                                                                  |
...
| 9   | paper_flg        | Boolean | -        | -    |        |        | 紙版取扱フラグ。デフォルト: false                                                             |
| 10  | denshi_flg       | Boolean | -        | -    |        |        | 電子版取扱フラグ。デフォルト: false                                                           |
| 11  | biko             | String  | -        | -    |        |        | 備考。空欄可                                                                                  |
...
| リクエストパラメーター | account_id（パスパラメータ）                                                                                                                                                                                                                               |
| ヘッダ                 | Content-Type: application/json※ 認証情報はHTTP-only Cookieにより自動的に送信される                                                                                                                                                                     |
| HTTPレスポンスコード   | 200:正常にアカウントを更新しました, 400:入力内容にエラーがあります, 401:セッションが切れました。再度ログインしてください, 403:この画面へのアクセス権限がありません, 404:指定されたアカウントが見つかりません, 500:システムエラーが発生しました |
...
| 7   | account_name     | String  | -        | 〇   | 1      | 50     | アカウント名称                                                                                |
| 8   | email            | String  | -        | -    |        | 100    | メールアドレス（メール形式）。空欄可                                                          |
| 9   | paper_flg        | Boolean | -        | -    |        |        | 紙版取扱フラグ                                                                                |
| 10  | denshi_flg       | Boolean | -        | -    |        |        | 電子版取扱フラグ                                                                              |
| 11  | biko             | String  | -        | -    |        |        | 備考。空欄可                                                                                  |
